...
public class DrivingSubsystem extends Subsystem {
	...
	/**
	 * Set the speed of the talons In addition, update the SmartDashboard's
	 * information about the encoders
	 * 
	 * @param leftSpeed
	 *            - The new speed of the left talons
	 * @param rightSpeed
	 *            - The new speed of the right talons
	 */
